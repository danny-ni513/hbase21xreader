...
public final class Key {
    ...
    public final static String SCAN_LIMIT_SIZE = "scanLimitSize";

    public final static String FILTER = "filter";

    public final static String FILTER_TYPE = "filter.type";

    public final static String FILTER_VALUE = "filter.value";
