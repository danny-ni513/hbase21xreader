...
public class Hbase21xReader extends Reader {
    public static class Job extends Reader.Job{
        ...
        public void init() {
            ...
            Hbase21xHelper.validateParameter(this.originConfig);
        }
        ...
        public List<Configuration> split(int i) {
            return Hbase21xHelper.split(this.originConfig);
        }
    }
    ...
    public static class Task extends Reader.Task{
        ...
        public void prepare() {
            try{
                ...
                throw DataXException.asDataXException(Hbase21xReaderErrorCode.PREPAR_READ_ERROR, e);
            }
        }
